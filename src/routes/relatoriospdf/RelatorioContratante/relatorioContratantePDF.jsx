                        ...
                        {arrayRelatorios.map((item) => (
                            <View style={styles.containerCard}>
                                ...
                                <View style={styles.infoCard}>
                                    <Text style={styles.titleInfo}>Motorista</Text>
                                ...
                                <View style={styles.infoCard}>
                                    <Text style={styles.titleInfo}>Job</Text>
                                    <View style={styles.itemInfo}>
                                        <Text>{item.job}</Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.infoCard}>
                                    <Text style={styles.titleInfo}>Inicio</Text>
                                    <View style={styles.itemInfo}>
                                ...
                                <View style={styles.infoCard}>
                                    <Text style={styles.titleInfo}>Termino</Text>
                                    <View style={styles.itemInfo}>
                                ...
                                <View style={styles.infoCard}>
                                    <Text style={styles.titleInfo}>Setor</Text>
                                    <View style={styles.itemInfo}>
                                ...
                                <View style={styles.infoCard}>
                                    <Text style={styles.titleInfo}>Atribuicao</Text>
                                    <View style={styles.itemInfo}>
                                ...
                                <View style={styles.infoCard}>
                                    <Text style={styles.titleInfo}>Horas trabalhadas</Text>
                                    <View style={styles.itemInfo}>
                                ...
                                <View style={styles.infoCard}>
                                    <Text style={styles.titleInfo}>Km rodado</Text>
                                    <View style={styles.itemInfo}>
